...
#if defined(__FRAMAC__)
/*  Here i removed the static in order to test this function in my entrypoint (function never called by other functions) */
...

{
    ...
    /*@ assert iface->rqst_handler ∈ {class_rqst_handler}; */
